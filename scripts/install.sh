...
/opt/elk-terraform/scripts/status-check.sh || echo "Some services may still be starting up..."

echo "✅ ELK-Terraform-Challenge101 deployment complete!"
echo "🔗 Access your services using the URLs provided in the Terraform output"